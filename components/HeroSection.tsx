...
export default function HeroSection() {
    ...
    // Resolve values - DB overrides or translations
    const name = heroData.hero_name || "MARWAN";
    const roleTitle = heroData.hero_title || t("hero.role");
    const tagline = heroData.hero_tagline || t("hero.welcome");
    const ctaPrimaryText = heroData.cta_primary_text || t("hero.viewProjects");
    const ctaPrimaryHref = heroData.cta_primary_href || "#projects";
    const ctaSecondaryText = heroData.cta_secondary_text || t("hero.getInTouch");
